...
# Define table columns (make sortable where it makes sense)
columns = [
    ...
    {"name": "is_shortlisted", "label": "Shortlisted", "field": "is_shortlisted", "align": "center", "sortable": True},
    {
        "name": "requirements",
...
# Create table (with default sorting by name)
table = ui.table(
    columns=columns,
    rows=rows,
    row_key="id",
