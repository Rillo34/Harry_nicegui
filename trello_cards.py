...
import niceGUI.draganddrop as dnd
...
with ui.row():
    with dnd.column('Next', on_drop=handle_drop):
        dnd.card(ToDo('Simplify Layouting'), badge_text="High", extra_label="Deadline: Jan")
        dnd.card(ToDo('Provide Deployment'), badge_text="Low", extra_label="Owner: Alex")
